...
function Map_geojson(ds) {
  ...
  L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{
   ...
   var geoJsonLayer = L.geoJSON(duto.utilitiey_query.features, {
    style: myStyle,
    //onEach feature use the importent in proprities system 
          
      onEachFeature: function( feature, layer) {
        var popupText = "id: <b>" + feature.properties.f1 + "</b>" + "<br>Town: <b>" + feature.properties.f2 + "</b>";
